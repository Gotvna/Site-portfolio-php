...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `backf` varchar(2000) NOT NULL,
  `h1` varchar(2000) NOT NULL,
  `paraf` varchar(2000) NOT NULL,
  `backs` varchar(2000) NOT NULL,
  `h2` varchar(2000) NOT NULL,
  `paras` varchar(2000) NOT NULL,
  `imgbodyf` varchar(2000) NOT NULL,
  `imgbodys` varchar(2000) NOT NULL,
  `backt` varchar(2000) NOT NULL,
  PRIMARY KEY (`pageid`)
