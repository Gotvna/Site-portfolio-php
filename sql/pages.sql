...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 30 nov. 2021 à 20:35
...
--
-- Structure de la table `projet-witcher`
--
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `background1` varchar(255) NOT NULL,
  `background2` varchar(255) NOT NULL,
  `background3` varchar(255) NOT NULL,
  `background4` varchar(255) NOT NULL,
  PRIMARY KEY (`pageid`)
